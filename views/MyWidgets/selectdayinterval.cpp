...
SelectDayInterval::SelectDayInterval(QWidget *parent) :
    QWidget(parent)
{
    ...
    QHBoxLayout * layoutCanal  = new QHBoxLayout();
    ...
    labelCanal = new QLabel("Canal ");
    comboCanal = new QComboBox();
    populateComboCanal();
    layoutCanal->addWidget(labelCanal);
    layoutCanal->addWidget(comboCanal);
...
void SelectDayInterval::getFolders()
{
    ...
    if(valide)
    {
        ...
        if(date2 > date1)
        {
            QString canal = comboCanal->itemText(comboCanal->currentIndex());
            ...
            emit intervalSelected(foldersList, finF, canal);
        }
        else
        {
...
void SelectDayInterval::populateComboDecoupage()
{
...
void SelectDayInterval::populateComboCanal()
{
    QList<QString> list;
    list = MultiCanalController::getTypesList();

    foreach(QString canal, list)
    {
        comboCanal->addItem(canal);
    }
}

void SelectDayInterval::populateComboHeure()
{
...
void SelectDayInterval::populateComboMinute()
{
...
void SelectDayInterval::selectDossier()
{
